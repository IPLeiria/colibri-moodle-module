 ...
 * SVN:
 * $Author: cesperanc $
 * $Date: 2011-06-20 22:18:25 +0100 (Seg, 20 Jun 2011) $
 * $Rev: 29 $
 */
...
/**
 * @example run the tests on the 'mod/colibri/simpletest' directory
 */
class ColibriService_test extends UnitTestCase {

    public static $includecoverage = array('mod/colibri/locallib.php');
    public static $excludecoverage = array('mod/colibri/simpletest');
